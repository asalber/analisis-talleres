...
En este taller trataremos de usar esta idea, usando _sumas de Riemann_, para aproximar el área que queda entre la gráfica de una función $f(x)=x^3$ y el eje $X$, en el intervalo $I=[0,1]$.
...
![](img/sumas-riemann/cubo-figure0.png)
:::

:::{.content-visible unless-format="html"}
![](img/sumas-riemann/cubo-figure0.pdf)
:::
